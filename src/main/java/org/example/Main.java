...
public class Main {
    public static void main(String[] args) {
        ...
        staff.registerStaff(Bank.staff , "Hameed Akorede" , "hameedkorede@gmail.com" , "09055589964");
        System.out.println(Bank.staff);
        staff.verifyAccountNumber("12345678986");
        staff.registerNewCustomer(Bank.customers , Bank.staff ,"hameedkorede@gmail.com" , "John Doe" , "johndoe@gmail.com", "Fbiswats1" , "09055589964" , "23487456876");
        staff.registerNewCustomer(Bank.customers , Bank.staff ,"hameedkorede@gmail.com", "Jane Doe" , "janedoe@gmail.com", "Fbiswats12" , "07016087515" , "12678496367");
        // customerService.
